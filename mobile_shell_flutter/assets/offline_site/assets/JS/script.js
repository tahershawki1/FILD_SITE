/*
    ...
    */
    ...
    function showHome(){
      ...
      const taskPageHeader = $("#taskPageHeader");
      if (mainHeader) mainHeader.style.display = "";
      if (taskPageHeader) taskPageHeader.style.display = "none";
      $("#topTitle").textContent = "لوحة العمليات الميدانية";
      $("#topSub").textContent = "واجهة تشغيل يومية بإدخال واضح ومخرجات فورية";
    ...
    function showTask(taskId){
      ...
      const mainHeader = $("#mainHeader");
      const taskPageHeader = $("#taskPageHeader");
      const taskPageTitle = $("#taskPageTitle");
      if (mainHeader) mainHeader.style.display = "none";
      if (taskPageHeader) taskPageHeader.style.display = "";
      if (taskPageTitle) taskPageTitle.textContent = task.title;
    ...
    (function init(){
      ...
      renderHomeCards();
      wireGlobalEvents();
      if(state.activeTaskId && TASKS.some(t => t.id === state.activeTaskId)) showTask(state.activeTaskId);
      else showHome();
      saveDebounced();
    })();
